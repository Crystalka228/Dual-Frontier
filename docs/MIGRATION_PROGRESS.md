...
| **Tests passing** | **1034 / 1036 reported** (2026-06-11 survey, per-suite Release runs — TESTING_STRATEGY §2.7 snapshot; the 2 failures are the F-10 pre-existing pair, recorded in the ROADMAP Findings ledger, not absorbed). Historical: 620 at A'.5 closure (2026-05-14, `fc8ecb6`); 936 → 1022 at К10.3 v2 (2026-05-20). |
