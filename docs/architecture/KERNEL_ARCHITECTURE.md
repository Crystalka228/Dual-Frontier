...
| K10 | Native kernel scheduler (К-L6 SUPERSEDED + К-L12/L13/L14 AUTHORED) | 4 sub-milestones (K10.1 = kernel scheduler core; K10.2 = native bus + mod ALC lifecycle; K10.3 = pipeline + display + hardware; K10.4 = TLA+ formal verification) | K10.1 ~16 commits +3000-4000 (kernel core); К10.2/3/4 future briefs |
