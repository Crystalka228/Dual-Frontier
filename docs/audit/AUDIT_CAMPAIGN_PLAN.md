...
register_id: DOC-E-AUDIT_CAMPAIGN_PLAN
category: E
tier: 3
lifecycle: EXECUTED
owner: Crystalka
...
register_view_url: docs/governance/REGISTER_RENDER.md#DOC-E-AUDIT_CAMPAIGN_PLAN
---
---
...
Кампания целиком прогоняется через **Opus** — она требует архитектурной интуиции и full system visibility, которые есть только у наиболее способной модели в текущей конфигурации pipeline'а.
