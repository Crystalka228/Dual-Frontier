...
- [DEVELOPMENT_HYGIENE](./DEVELOPMENT_HYGIENE.md) — PR-чек-лист на Phase 4–7, защищающий границу движок / игра.
- [METHODOLOGY](./METHODOLOGY.md) — ритуал закрытия фазы и self-teaching между фазами.
