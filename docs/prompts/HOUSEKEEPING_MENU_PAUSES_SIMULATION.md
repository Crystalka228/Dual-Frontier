...
6. `docs/MOD_OS_ARCHITECTURE.md` §9.2 wording — quote the exact spec line in the ROADMAP closure entry. Confirms whether the two-flag implementation is a §9.2 ambiguity worth flagging as v1.6 candidate.
