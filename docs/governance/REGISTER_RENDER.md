...
- [Category J (5 documents)](#category-J)
...
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-24 (`PENDING-COMMIT-A_PRIME_9_0-CLOSURE`)
...
### DOC-A-ANALYZER_RULES — DualFrontier Roslyn Analyzer Rule Specifications (historical; superseded by authored rework)

- **Path**: `docs/architecture/historical/ANALYZER_RULES.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 0.4.1
...
- **Path**: `docs/architecture/historical/ARCHITECTURE.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 1.0.0
- **Owner**: Crystalka  |  **Content language**: en
...
- **Path**: `docs/architecture/historical/COMBO_RESOLUTION.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 0.2.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`0145f1b`)
- **Next review due**: null
- **Special-case rationale**: Superseded by DOC-J-COMBO_RESOLUTION per corpus rework EVT-2026-07-15-CORPUS_REWORK_R4_MECHANICS. Last-ratified reference preserved at docs/architecture/historical/COMBO_RESOLUTION.md until successor ratification (deliberate authority-gap window; FRAMEWORK §7). Prior rationale: A vs J borderline classified as A by A'.4.5 execution agent — predominantly architectural pattern (deterministic ordering via ComboResolutionSystem); mechanic-design intent minimal. Cross-referenced from docs/mechanics/ index when future J-category combat-design doc authored
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-15 (`PENDING-INITIAL`)
...
- **Tier**: 1  |  **Lifecycle**: AUTHORED  |  **Version**: 0.1.2
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`6888246`)
- **Next review due**: post-ratification closure
...
### DOC-A-CONTRACTS — Contract system (historical; superseded by authored rework)

- **Path**: `docs/architecture/historical/CONTRACTS.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 1.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`6888246`)
- **Next review due**: null
...
- **Path**: `docs/architecture/historical/ECS.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 1.1.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`fe27fbe`)
- **Next review due**: null
...
### DOC-A-EVENT_BUS — Event buses (historical; superseded by authored rework)

- **Path**: `docs/architecture/historical/EVENT_BUS.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 2.0.0
- **Owner**: Crystalka  |  **Content language**: en
...
### DOC-A-FEEDBACK_LOOPS — Feedback-loop resolution (historical; engine rule → THREADING, gameplay residue reclassified Category J)

- **Path**: `docs/architecture/historical/FEEDBACK_LOOPS.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 0.2.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`0145f1b`)
- **Next review due**: null
- **Special-case rationale**: Split per corpus rework EVT-2026-07-15-CORPUS_REWORK_R4_MECHANICS: the engine cycle/snapshot rule is normative in DOC-A-THREADING_V2 §7 (absorbed at cascade R1); the gameplay residue is DOC-J-FEEDBACK_LOOPS in docs/mechanics/. Scalar superseded_by points to the J residue; the THREADING absorption is recorded in both EVTs. Full text preserved at docs/architecture/historical/FEEDBACK_LOOPS.md.

### DOC-A-FHE_INTEGRATION_CONTRACT — FHE Integration Contract (historical; superseded by authored rework)

- **Path**: `docs/architecture/historical/FHE_INTEGRATION_CONTRACT.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 1.0.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`fcbfe5b`)
- **Next review due**: null
...
- **Path**: `docs/architecture/historical/FIELDS.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 0.1.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`fcbfe5b`)
- **Next review due**: null
...
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`7449ba8`)
...
### DOC-A-ISOLATION — System isolation (historical; merged into the MOD_OS authored rework)

- **Path**: `docs/architecture/historical/ISOLATION.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 1.1.2
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`6888246`)
- **Next review due**: null
...
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-07-02 (`59c1802`)
...
- **Tier**: 2  |  **Lifecycle**: Live  |  **Version**: 0.2.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-02 (`5c34946`)
- **Next review due**: 2026-Q3
- **Special-case rationale**: Category A + Tier 2 Live: forward-evolving dashboard appended per cascade closure. The original AUTHORED-SKELETON override (populated к Tier 2 Live при 3+ post-closure verifications) resolved at A'.9.1 Phase δ (2026-07-02) — §6 gate satisfied at verification #14 (four post-closure entries #11/#12/#13/#14; schema stable since #11); promoted to Live. Tier 2 Live → Tier 1 LOCKED remains gated on К-L14 thesis credibility maturity (post-Phase B+; criterion 5 deferred status resolved).
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-10 (`0789bd4`)
- **Special-case rationale**: Amendment plans behave like briefs (EXECUTED post-landing, not LOCKED); Category A + Tier 3 + EXECUTED override per Pass 2 §1.3
- **Risks referenced**: RISK-004, RISK-008

### DOC-A-KERNEL — DualFrontier Kernel — Architecture (historical; superseded by authored rework)

- **Path**: `docs/architecture/historical/KERNEL_ARCHITECTURE.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 2.6.2
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`fe27fbe`)
- **Next review due**: null
...
- **Path**: `docs/architecture/historical/KERNEL_FULL_NATIVE_SCHEDULER.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 2.0
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-07-15 (`fe27fbe`)
- **Next review due**: null
...
- **Path**: `docs/architecture/historical/MAXIMUM_ENGINEERING_REFACTOR_TRACK_B_ACTIVATION.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 0.1.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`6888246`)
- **Next review due**: null
- **Special-case rationale**: Track B activation brief retired with the DF_TS program per session finding N-13 (pre-activation invariant falsified by A'.9.1; trigger event stale after Option-c reordering). Superseded by DOC-A-ANALYZER_RULES_V2 §5 per corpus rework EVT-2026-07-15-CORPUS_REWORK_R2_PLATFORM. Full text preserved at docs/architecture/historical/MAXIMUM_ENGINEERING_REFACTOR_TRACK_B_ACTIVATION.md. Prior rationale: Draft — Track B activation pending Phase A'.9 analyzer milestone; v0.1 conceptual draft

### DOC-A-MIGRATION_PLAN — Migration Plan — Kernel-to-Vanilla (K-series → M-series) (historical; executed portion is history, forward state lives in ROADMAP)

- **Path**: `docs/architecture/historical/MIGRATION_PLAN_KERNEL_TO_VANILLA.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 1.4.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`6888246`)
- **Next review due**: null
...
### DOC-A-MOD_OS — Mod OS Architecture — Dual Frontier (historical; superseded by authored rework)

- **Path**: `docs/architecture/historical/MOD_OS_ARCHITECTURE.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 1.12.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`6888246`)
- **Next review due**: null
...
- **Path**: `docs/architecture/historical/MOD_PIPELINE.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 0.3
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`6888246`)
- **Next review due**: null
...
- **Path**: `docs/architecture/historical/MODDING.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 1.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`6888246`)
- **Next review due**: null
...
- **Path**: `docs/architecture/historical/OWNERSHIP_TRANSITION.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 1.0.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`0145f1b`)
- **Next review due**: null
- **Special-case rationale**: Reclassified Category A → J per corpus rework EVT-2026-07-15-CORPUS_REWORK_R4_MECHANICS (gameplay golem-bond protocol; session finding N-6 title collision with architecture vocabulary — successor renamed GOLEM_OWNERSHIP). Category change requires a new ID per FRAMEWORK §5 immutability + G-NAMESPACE; sanctioned path = supersession (I→A promotion precedent §3.1.1). Full text preserved at docs/architecture/historical/OWNERSHIP_TRANSITION.md.

### DOC-A-PERFORMANCE — Performance (historical; superseded by authored rework)

- **Path**: `docs/architecture/historical/PERFORMANCE.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 1.1.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`fcbfe5b`)
- **Next review due**: null
...
- **Tier**: 2  |  **Lifecycle**: Live  |  **Version**: Live
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-06-12 (`f2e6df2`)
- **Next review due**: 2026-Q3
...
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-25 (`PENDING-COMMIT-A_PRIME_9_1-AXIOM-CODIFICATION`)
- **Next review due**: 2027-05-25
- **Meta entry**: yes (role=register_framing)

### DOC-A-RESOURCE_MODELS — Resource models (historical; reclassified Category J — docs/mechanics)

- **Path**: `docs/architecture/historical/RESOURCE_MODELS.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`0145f1b`)
- **Next review due**: null
- **Special-case rationale**: Superseded by DOC-J-RESOURCE_MODELS per corpus rework EVT-2026-07-15-CORPUS_REWORK_R4_MECHANICS. Last-ratified reference preserved at docs/architecture/historical/RESOURCE_MODELS.md until successor ratification (deliberate authority-gap window; FRAMEWORK §7). Prior rationale: A vs J borderline classified as A by A'.4.5 execution agent — architectural data structure approach for resource modeling; gameplay-design layer captured separately if/when J-category resource-balance doc authored
...
- **Tier**: 1  |  **Lifecycle**: AUTHORED  |  **Version**: 0.1.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`0145f1b`)
- **Next review due**: post-ratification closure
...
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-25 (`PENDING-COMMIT-A_PRIME_9_1-CROSSREFS`)
- **Next review due**: 2027-05-25
- **Meta entry**: yes (role=register_provenance)

### DOC-A-THREADING — Multithreading (historical; superseded by authored rework)

- **Path**: `docs/architecture/historical/THREADING.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 2.0.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`fe27fbe`)
- **Next review due**: null
...
### DOC-A-VULKAN_SUBSTRATE — Vulkan Substrate (V) — Dual Frontier (historical; superseded by authored rework)

- **Path**: `docs/architecture/historical/VULKAN_SUBSTRATE.md`
- **Tier**: 1  |  **Lifecycle**: SUPERSEDED  |  **Version**: 1.2.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`fcbfe5b`)
- **Next review due**: null
...
- **Tier**: 1  |  **Lifecycle**: LOCKED  |  **Version**: 2.1.3
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`673f815`)
...
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-06-29 (`27807f7`)
- **Next review due**: 2027-06-11
...
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-07-02 (`0411bb0`)
- **Next review due**: 2027-05-10
...
- **Tier**: 2  |  **Lifecycle**: LOCKED  |  **Version**: 1.0.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-02 (`0411bb0`)
- **Next review due**: 2026-Q3
...
- **Tier**: 1  |  **Lifecycle**: LOCKED  |  **Version**: 2.2.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`673f815`)
- **Next review due**: 2027-06-11
...
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-06 (`PENDING-INITIAL`)
- **Next review due**: 2026-Q3
...
- **Tier**: 2  |  **Lifecycle**: Live  |  **Version**: Live
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-07-02 (`c4119b0`)
- **Next review due**: 2026-Q3
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-10 (`4e332bb`)
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-12 (`411c284`)
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-12 (`7448267`)
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-22 (`PENDING-COMMIT-A_PRIME_7_5-CLOSURE`)
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-21 (`PENDING-COMMIT-A_PRIME_7_X-CLOSURE`)
...
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-17 (`8b47133`)
...
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-24 (`PENDING-COMMIT-A_PRIME_9_0-AMENDMENTS`)
...
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-24 (`bb6807c`)
...
- **Tier**: 3  |  **Lifecycle**: AUTHORED-SKELETON  |  **Version**: 0.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-17 (`14521b8`)
...
- **Tier**: 4  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-06-12 (`0890645`)
...
### DOC-D-CODEX_CLOSURE_BRIEF — CODEX_CLOSURE -- Execution Brief (properly gates and closes the half-closed Codex closed-PR remediation cascade: FOLD the Skarlet-gate H2b census-delta, fix F-13 at root, retire the CX-14 no-op props, amend the report by APPEND, close the register 2.23 -> 2.24)

- **Path**: `tools/briefs/CODEX_CLOSURE_BRIEF.md`
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`eacf604`)
...
- **Tier**: 4  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-06-02 (`PENDING-COMMIT-DOC_DRIFT_RECON-ENROLLMENT`)
...
### DOC-D-F10_TEST_ISOLATION_BRIEF — F10_TEST_ISOLATION_BRIEF — F-10 test-isolation cascade execution brief (FIX + RECLASSIFY/QUARANTINE + CODIFY: RunningLoop determinism closes F-10 #2; 13 Fixture.RegularMod_* -> DualFrontier.sln + fixture-deployment guard; Extreme S1/S2/S7 Skip-quarantine; TESTING_STRATEGY 2.1.0 invocation-safety law; F-10 CLOSED / F-29 seeded / F-28(a) folded; REGISTER 2.21 -> 2.22)

- **Path**: `tools/briefs/F10_TEST_ISOLATION_BRIEF.md`
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-03 (`88b6f58`)
...
### DOC-D-F29_NATIVE_SCHEDULER_BRIEF — F29_NATIVE_SCHEDULER_BRIEF — F-29 native-scheduler cascade execution brief (FIX defect (b) O(N^2) -> O(N+E) index-keyed graph rebuild + FIX defect (a) fail-loud native concurrency detector on the lock-free scheduler-graph + wake-registry singletons + a shared xUnit collection over the singleton-touching classes; un-quarantine S1/S7; re-point S2 -> F-30; S3/S4/S5 bus-load artifact -> F-31; TESTING_STRATEGY 2.1.0 -> 2.2.0 §2.8 isolation law; F-29 CLOSED / F-30 + F-31 seeded; REGISTER 2.22 -> 2.23)

- **Path**: `tools/briefs/F29_NATIVE_SCHEDULER_BRIEF.md`
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-04 (`c0ab964`)
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-23 (`PENDING-COMMIT-A_PRIME_8_K_CLOSURE-RATIFICATION`)
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-23 (`PENDING-COMMIT-K_EXT_2-CLOSURE`)
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-23 (`PENDING-COMMIT-K_EXT_3-CLOSURE`)
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-09 (`PENDING-INITIAL`)
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-07 (`PENDING-INITIAL`)
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-18 (`PENDING-COMMIT-K10_1-CLOSURE`)
- **Next review due**: null
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-18 (`PENDING-COMMIT-K10_2-CLOSURE`)
- **Next review due**: null
...
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-20 (`PENDING-COMMIT-K10_3-V2-CLOSURE`)
- **Next review due**: null
...
- **Tier**: 3  |  **Lifecycle**: AUTHORED-SKELETON  |  **Version**: 0.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-17 (`30bd613`)
...
- **Tier**: 3  |  **Lifecycle**: AUTHORED-SKELETON  |  **Version**: 0.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-17 (`07551df`)
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-08 (`PENDING-INITIAL`)
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 2.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-09 (`0789bd4`)
- **Risks referenced**: RISK-001
- **CAPA referenced**: CAPA-2026-05-09-K8.2-V2-REFRAMING
...
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-16 (`f7e6d52`)
...
- **Tier**: 3  |  **Lifecycle**: SUPERSEDED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-16 (`8cf94b3`)
...
- **Tier**: 3  |  **Lifecycle**: SUPERSEDED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-14 (`54c6658`)
...
- **Tier**: 3  |  **Lifecycle**: AUTHORED-SKELETON  |  **Version**: 0.1
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-18 (`4bc34c1`)
- **Next review due**: null
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-11 (`80c9ba6`)
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-04-XX (`7448267`)
...
- **Tier**: 4  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-06-11 (`d90b522`)
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-18 (`PENDING-COMMIT-V0_A-CLOSURE`)
- **Next review due**: null
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-18 (`PENDING-COMMIT-V0_B-CLOSURE`)
- **Next review due**: null
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-19 (`PENDING-COMMIT-V0_C_1-CLOSURE`)
- **Next review due**: null
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-19 (`PENDING-COMMIT-V0_C_2-CLOSURE`)
- **Next review due**: null
...
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-19 (`PENDING-COMMIT-V1-CLOSURE`)
- **Next review due**: null
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-10 (`43374f1`)
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-12 (`43374f1`)
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-13 (`b46a6c6`)
- **CAPA referenced**: CAPA-2026-05-13-K8.3-PREMISE-MISS
...
### DOC-E-A_PRIME_9_1_ARC_CLOSURE_REPORT — A'.9.1 ARC CLOSURE REPORT — Analyzer Infrastructure (К-extensions cascade #5) — the arc's durable record (git-verified phase table + per-phase deliverables; Q-L-1 gate 23 → CONTINUE, 15 genuine in 2 clusters; Release 1.0 severity matrix; census pins final state; lessons formalized; falsifiability-anchor readout; operator ratifications ledger; Phase δ execution record + self-attestation)

- **Path**: `docs/reports/A_PRIME_9_1_ARC_CLOSURE_REPORT.md`
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-02 (`8ec64c5`)
- **Special-case rationale**: Durable arc-closure report enrolled DOC-E Tier 3 per the docs/reports/ convention (the γ-recon precedent class). The arc's citable closure record — replaces the chat-only closure-report precedent of the β/γ phase closures for the arc-level record per the delta brief §3 ratified decision 8.

### DOC-E-A_PRIME_9_1_PHASE_DELTA_RECON_REPORT — PHASE DELTA RECON REPORT — 2026-07-01 (R1-R8) — pre-brief reconnaissance for the A'.9.1 Phase δ governance closure (base state; METHODOLOGY lesson-entry shapes + #N census + per-lesson source tables + the #N17 transcription source; dashboard #14 shape + Live gate arithmetic; arc-closure surface + phase-hash table + ANALYZER_RULES promotion blocker; F-ledger sweep F-7/F-27 full texts; rider shapes; 12 anomalies + scale estimate)

- **Path**: `docs/reports/PHASE_DELTA_RECON_REPORT.md`
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-01 (`f2841c1`)
- **Special-case rationale**: Durable-report recon enrolled DOC-E Tier 3 per the docs/reports/ convention (precedent: DOC-E-A_PRIME_9_1_PHASE_GAMMA_RECON_REPORT — the first durable-report recon; this is the second). Basis of DOC-D-A_PRIME_9_1_PHASE_DELTA_BRIEF; substituted for a survey wave per the brief preamble.
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-04-XX (`411c284`)
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-04-XX (`PENDING-INITIAL`)
...
- **Tier**: 2  |  **Lifecycle**: Live  |  **Version**: Live
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-06-02 (`PENDING-COMMIT-DOC_DRIFT_RECON-PROGRESS`)
...
### DOC-E-F10_TEST_ISOLATION_RECON_REPORT — F10_TEST_ISOLATION RECON REPORT — 2026-07-02 (R1-R9) — pre-brief measurement recon for the F-10 test-isolation cascade (full failure census Debug + Release; Stress/Extreme/thread-safety characterization; bootstrap-timing sweep; the zombie-testhost stdout-pipe deadlock A/B; fixture-copy MSBuild wiring root-cause; anomalies + scale estimate + proposed decision surface)

- **Path**: `docs/reports/F10_TEST_ISOLATION_RECON_REPORT.md`
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-02 (`88b6f58`)
- **Special-case rationale**: Durable-report recon enrolled DOC-E Tier 3 per the docs/reports/ convention (precedents: DOC-E-A_PRIME_9_1_PHASE_GAMMA_RECON_REPORT, DOC-E-A_PRIME_9_1_PHASE_DELTA_RECON_REPORT). Basis of DOC-D-F10_TEST_ISOLATION_BRIEF; substituted for a survey wave per the brief basis line.

### DOC-E-F29_NATIVE_SCHEDULER_RECON_REPORT — F29_NATIVE_SCHEDULER RECON REPORT — 2026-07-04 (R1-R7) — pre-brief measurement recon for the F-29 native-scheduler cascade (scheduler code-surface map: SystemGraph / WakeRegistry / native-bus singleton topology + lock-free vs mutex audit; defect (a) crash-under-load reproduced with SEH signatures; defect (b) N -> time scale curves confirming the O(N^2) rebuild; root-cause hypotheses + fix directions; the S1/S2/S7 re-enable prospect; the S2 managed-vs-native mis-grouping)

- **Path**: `docs/reports/F29_NATIVE_SCHEDULER_RECON_REPORT.md`
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-04 (`c0ab964`)
- **Special-case rationale**: Durable-report recon enrolled DOC-E Tier 3 per the docs/reports/ convention (precedents: DOC-E-F10_TEST_ISOLATION_RECON_REPORT, DOC-E-A_PRIME_9_1_PHASE_GAMMA_RECON_REPORT). Basis of DOC-D-F29_NATIVE_SCHEDULER_BRIEF; substituted for a survey wave per the brief basis line.
...
- **Tier**: 3  |  **Lifecycle**: Live  |  **Version**: Live
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-09 (`8ee27fe`)
- **Next review due**: 2026-Q3
...
### DOC-E-REGISTER_INVERSION_A_MEASURE_REPORT — REGISTER_INVERSION Cascade A — Measure Report (Cascade B work order)

- **Path**: `docs/reports/REGISTER_INVERSION_A_MEASURE_REPORT.md`
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`e1eace0`)
- **Next review due**: null
...
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-05-21 (`d179631`)
...
### DOC-E-VALIDATOR_2_RECON_REPORT — VALIDATOR_2 Recon Report — governance validator gap census

- **Path**: `docs/reports/VALIDATOR_2_RECON_REPORT.md`
- **Tier**: 3  |  **Lifecycle**: EXECUTED  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`817921d`)
- **Next review due**: null
...
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-06-29 (`192a4e3`)
...
- **Tier**: 4  |  **Lifecycle**: Live  |  **Version**: Live
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-04-XX (`fe35f00`)
...
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-12 (`8ee27fe`)
...
- **Tier**: 2  |  **Lifecycle**: Live  |  **Version**: Live
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-12 (`b655d4b`)
- **Next review due**: 2026-Q3
...
- **Tier**: 2  |  **Lifecycle**: Live  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-05-12 (`fe35f00`)
- **Next review due**: 2026-Q3
...
- **Tier**: 2  |  **Lifecycle**: Live  |  **Version**: 1.0
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-04-26 (`b655d4b`)
- **Next review due**: 2026-Q3
...
- **Tier**: 2  |  **Lifecycle**: Live  |  **Version**: Live
- **Owner**: Crystalka  |  **Content language**: mixed
- **Last modified**: 2026-04-XX (`8ee27fe`)
- **Next review due**: 2026-Q3
...
### DOC-J-COMBO_RESOLUTION — Combo resolution — damage-merge mechanic design (Category J; reclassified from DOC-A-COMBO_RESOLUTION)

- **Path**: `docs/mechanics/COMBO_RESOLUTION.md`
- **Tier**: 1  |  **Lifecycle**: Draft  |  **Version**: 0.1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`0145f1b`)
- **Next review due**: 2027-07-15

### DOC-J-COMPOSITE_REQUESTS — Composite requests — multi-bus transaction mechanic design (Category J; reclassified from DOC-A-COMPOSITE_REQUESTS)

- **Path**: `docs/mechanics/COMPOSITE_REQUESTS.md`
- **Tier**: 1  |  **Lifecycle**: Draft  |  **Version**: 0.1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`0145f1b`)
- **Next review due**: 2027-07-15

### DOC-J-FEEDBACK_LOOPS — Feedback loops — mechanic applications of the cycle/snapshot rule (Category J; engine rule normative in DOC-A-THREADING_V2)

- **Path**: `docs/mechanics/FEEDBACK_LOOPS.md`
- **Tier**: 1  |  **Lifecycle**: Draft  |  **Version**: 0.1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`0145f1b`)
- **Next review due**: 2027-07-15

### DOC-J-GOLEM_OWNERSHIP — Golem ownership — mage-golem bond mechanic design (Category J; renamed successor of DOC-A-OWNERSHIP_TRANSITION; shipped-claim corrected to stub truth)

- **Path**: `docs/mechanics/GOLEM_OWNERSHIP.md`
- **Tier**: 1  |  **Lifecycle**: Draft  |  **Version**: 0.1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`0145f1b`)
- **Next review due**: 2027-07-15

### DOC-J-RESOURCE_MODELS — Resource models — Intent vs Lease mechanic design (Category J; reclassified from DOC-A-RESOURCE_MODELS; honesty banner added per N-7)

- **Path**: `docs/mechanics/RESOURCE_MODELS.md`
- **Tier**: 1  |  **Lifecycle**: Draft  |  **Version**: 0.1.0
- **Owner**: Crystalka  |  **Content language**: en
- **Last modified**: 2026-07-15 (`0145f1b`)
- **Next review due**: 2027-07-15
...
| RISK-004 | Cross-document drift between LOCKED specs (KERNEL/MOD_OS/VULKAN_SUBSTRATE/MIGRATION_PLAN) | ACTIVE | Architectural | Medium-High | High |
