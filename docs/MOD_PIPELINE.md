...
**Модульный конвейер интеграции модов.** Версионирование документа
ведётся через [ARCHITECTURE §«История изменений»](./ARCHITECTURE.md#история-изменений);
здесь штамп версии не дублируется.
