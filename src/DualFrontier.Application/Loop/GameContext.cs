...
/// same scheduler / services / pipeline state. The caller (the Launcher's
/// Program in production, integration tests in DualFrontier.Modding.Tests) uses
...
/// DualFrontier.Launcher via the existing
