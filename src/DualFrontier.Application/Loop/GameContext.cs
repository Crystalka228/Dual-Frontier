...
/// same scheduler / services / pipeline state. The caller (production host
/// и integration tests in DualFrontier.Modding.Tests) uses
...
/// accessibility rules). Reachable from DualFrontier.Modding.Tests via the
/// existing <c>InternalsVisibleTo</c> declaration on the Application project.
/// </summary>
