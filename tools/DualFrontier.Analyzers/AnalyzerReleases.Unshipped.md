...
DFL025-A | DualFrontier.Discipline     | Info     | Lesson #25 — [ReservedStub] behavior invocation needs [Trait] (Warning post-promotion). [Documentation](https://github.com/Crystalka228/Dual-Frontier/blob/main/docs/architecture/ANALYZER_RULES.md#dfl025-a)
DFL025-B | DualFrontier.Discipline     | Info     | Lesson #25 — standalone tests against reserved stubs should use [Fact(Skip=...)] (Suggestion post-promotion). [Documentation](https://github.com/Crystalka228/Dual-Frontier/blob/main/docs/architecture/ANALYZER_RULES.md#dfl025-b)
