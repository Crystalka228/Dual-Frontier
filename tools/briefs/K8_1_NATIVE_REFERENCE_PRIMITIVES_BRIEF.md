...
register_view_url: docs/governance/REGISTER_RENDER.md#DOC-D-K8_1
---
...
**Reference docs**: `docs/architecture/KERNEL_ARCHITECTURE.md` v1.2 LOCKED (K-L11 production storage backbone, K-L3 implication extended), `docs/MIGRATION_PROGRESS.md` (K8.0 closure + Solution A roadmap), `docs/methodology/CODING_STANDARDS.md`, native module docs (`native/DualFrontier.Core.Native/MODULE.md`, `native/DualFrontier.Core.Native/include/MODULE.md`, `native/DualFrontier.Core.Native/src/MODULE.md`)
