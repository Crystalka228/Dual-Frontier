...
/// <summary>
/// Vanilla Magic mod skeleton. Currently empty — content lands in M10.B Magic
/// (per MOD_OS_ARCHITECTURE v1.5 §1.3 strategic LOCKED decision #4).
/// Establishes the assembly, manifest, and IMod entry point so the mod is
/// discoverable and loadable while the DualFrontier.Systems.Magic kernel-level
...
public sealed class MagicMod : IMod
{
    ...
    /// registered in the M8 skeleton. Content lands in M10.B.
    /// </summary>
